 ...
 *
 * Displays the HTML form for entering details of a new product.
...
require_once __DIR__ . '/../../config.php'; // Provides STORE_NAME, etc.
...
require_once __DIR__ . '/../../templates/header.php'; // Defines BASE_URL

// --- Determine Cancel URL ---
// Prefer BASE_URL if defined, otherwise use relative path
$cancel_url = defined('BASE_URL') ? BASE_URL . 'index.php?view=products' : '../../index.php?view=products';

?>

<div class="container mx-auto px-4 py-6 max-w-2xl"> <nav aria-label="breadcrumb" class="mb-4 text-sm text-gray-600">
      <ol class="list-none p-0 inline-flex space-x-2">
        <li><a href="<?php echo $cancel_url; ?>" class="text-blue-600 hover:underline">Product Management</a></li>
    ...
    <form action="add_product_handler.php" method="POST" class="bg-white p-6 md:p-8 rounded-lg shadow-lg space-y-5 border border-gray-200">
        ...
        <div class="flex justify-end items-center space-x-4 pt-5 border-t border-gray-200 mt-6">
             <a href="<?php echo $cancel_url; ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-5 rounded-md shadow-sm border border-gray-300 transition duration-150 ease-in-out">
                Cancel
             </a>
             <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-5 rounded-md shadow-sm hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-150 ease-in-out">
